...
const Navbar = (cart) => {
  ...
  return (
    <div className="nav flex justify-between items-center bg-[#333333] text-white p-6 shadow-lg ">
      <h1 className="text-3xl font-bold text-[#FFBF00]"> <i className='ri-reactjs-fill text-blue-500'></i> Cart-Zone </h1>  {/* Golden color for brand text */}
      <div className="flex gap-10">
        <Link to="/" className="text-lg font-medium hover:text-[#FFBF00] transition-colors">All Products</Link>
        <Link to="/wishlist" className="text-lg font-medium hover:text-[#FFBF00] transition-colors cursor-pointer"> Wishlist</Link>
